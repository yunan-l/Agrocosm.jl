...
function _transition_range!(
    ...
    common = (
        ...
        expansion_stress = simulation.config.expansion_stress,
        cold_sterility = simulation.config.cold_sterility,
        establishment = simulation.config.establishment,
        excess_water = simulation.config.excess_water,
        diurnal_temperature_stress = simulation.config.diurnal_temperature_stress,
        diurnal_stress_steps = Int(simulation.config.subdaily_steps),
        diurnal_stress_shape = simulation.config.diurnal_shape,
...
function _validate_checkpoint_target(simulation::CropSimulation, checkpoint)
    ...
    checks = (
        ...
        ("expansion stress", metadata.expansion_stress, simulation.config.expansion_stress),
        ("cold sterility", metadata.cold_sterility,
         simulation.config.cold_sterility),
        ("excess water", metadata.excess_water, simulation.config.excess_water),
        ("diurnal temperature stress", metadata.diurnal_temperature_stress,
         simulation.config.diurnal_temperature_stress),
