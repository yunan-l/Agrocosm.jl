...
@testset "Agrocosm.jl" begin
    ...
    include("processes/climate/test_diurnal.jl")
    include("processes/climate/test_diurnal_temp_stress.jl")
    include("processes/climate/test_leaf_energy.jl")
    include("processes/crop/test_reproductive_sink.jl")
    include("processes/crop/test_anthesis_heat.jl")
    include("processes/crop/test_cold_sterility.jl")
    include("processes/crop/test_water_plateau.jl")
    include("processes/crop/test_aerodynamic_coupling.jl")
    include("processes/crop/test_uptake_distribution.jl")
    include("processes/crop/test_grain_elasticity.jl")
    include("processes/crop/test_filling_stress.jl")
    include("processes/crop/test_establishment.jl")
    include("processes/crop/test_drought_phenology.jl")
    include("processes/crop/test_canopy_loss.jl")
    include("processes/crop/test_nitrogen_vcmax_relaxation.jl")
    include("processes/crop/test_grain_sink.jl")
    include("processes/crop/test_pmodel.jl")
    include("processes/crop/test_excess_water.jl")
    include("processes/crop/test_lodging.jl")
    include("processes/crop/test_heat_exposure.jl")
    include("processes/crop/test_terminal_heat.jl")
    include("processes/crop/test_water_sterility.jl")
    include("processes/crop/test_water_filling.jl")
    include("processes/crop/test_senescent_leaf_release.jl")
    ...
    include("processes/crop/test_season_diagnostics.jl")
    ...
    include("processes/soil/test_surface_ponding.jl")
    ...
    include("simulations/test_ablation.jl")
    include("simulations/test_global_process_settings.jl")
    include("simulations/test_simulation_api.jl")
    include("simulations/test_production_outputs.jl")
