...
@testset "Daily water-balance diagnostics" begin
    ...
    Agrocosm.record_water_balance_start!(water_balance, 1, state, Float32[10.0])
    ...
    Agrocosm.record_water_balance_end!(water_balance, 1, state, state)
    ...
    Agrocosm.record_water_balance_start!(water_balance, 2, state, Float32[3.0])
    ...
    Agrocosm.record_water_balance_end!(water_balance, 2, state, state)
    ...
    Agrocosm.record_water_balance_start!(water_balance, 3, state, Float32[4.0])
    ...
    soil.water.lateral_runoff .= 0.0f0
    soil.water.bottom_drainage .= 0.0f0
    Agrocosm.record_water_balance_end!(water_balance, 3, state, state)
